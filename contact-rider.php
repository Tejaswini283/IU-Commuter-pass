...
<title>Contact Rider - IUCommuterPass(IUCP)</title>
...
<?php include("include/sidebar.php");?>
        ...
        <div class="content">
            ...
            <div class="row animated fadeInRight">
                <div class="col-sm-12">
                    <h4 class="section-subtitle"><b>Contact Rider</b></h4>
                    <div class="panel">
...
$select = mysqli_query($con,"SELECT contact.*,r.Id as rid,p.first_name as p_fname,p.last_name  as p_lname,r.first_name as rider_fname,r.last_name as rider_lname FROM contact left JOIN users as p on p.id=contact.passenger_id left JOIN users as r on r.id=contact.rider_id WHERE contact.date=curdate() and contact.passenger_id='$sessionid' order by contact.id desc");
...
<tr>
    <td><?= $fetchOne['rider_fname'] ?> <?= $fetchOne['rider_lname'] ?></td>
    <td><?= $fetchOne['msg'] ?></td>
    <td><?= $fetchOne['date'] ?></td>
    <td><?= $fetchOne['time'] ?></td>
    <td><a href="message.php?rider=<?= $fetchOne['rid'] ?>" class="btn btn-success">Contact</a></td>
</tr>
